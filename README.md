...
## База данных м картинки

Для запуска приложения нужно утановить базу с примером данных (файл "sample-data.zip")

- распакуйте файл "db.sqlite3" в корень проекта (папку с файлом "manage.py")

- распакуйте содержимое архивной папки "media" в папку "media" вашего проекта   
